...
const addNote = (title,body) => {
    ...
    if(!duplicateNote){ // if(duplicateNote === undefined) -> if there is no match then find method will return undefined
        notes.push({
            title:title,
            body:body
        })
...
const readNote = (title) => {
    ...
    if(note){
        console.log(chalk.inverse.bold.green(note.title))
